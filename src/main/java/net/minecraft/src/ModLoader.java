...
public class ModLoader
{
    ...
    /**
     * Adds localization info for an achievement, Not used on the huix.mixins.server.
     *
    ...
    {
        String achName=achievement.getDescription();
...
//    	BlockDispenser.field_82527_a.func_82595_a(item, behavior);
    ...
    /**
     * Unimplemented on the huix.mixins.server as it does not generate names
     *
     * @param instance Item to name
     ...
     *
     * Unimplemented on the huix.mixins.server as it does not render textures
     *
...
*/    }
    ...
    /**
     * Stubbed method on the huix.mixins.server to return a unique model id
     *
     */
    @SideOnly(CLIENT)
    @Deprecated
...
//    }
    ...
    /**
     * Send a packet from client to huix.mixins.server
     *
     * @param packet
     */
    @Deprecated
    ...
    /**
     * Send a chat message to the huix.mixins.server
     *
     * @param text
     */
    @Deprecated
