...
public class PacketDispatcher
{
    ...
    public static void sendPacketToAllAround(double X, double Y, double Z, double range, int dimensionId, Packet packet)
    {
        ...
        {
            FMLLog.fine("Attempt to send packet to all around without a huix.mixins.server instance available");
        }
    }
    ...
    public static void sendPacketToAllInDimension(Packet packet, int dimId)
    {
        ...
        {
            FMLLog.fine("Attempt to send packet to all in dimension without a huix.mixins.server instance available");
        }
    }
