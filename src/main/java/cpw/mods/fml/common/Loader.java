...
public class Loader
{
    ...
    public boolean serverStarting(Object server)
    {
        ...
        {
            FMLLog.log(Level.SEVERE, t, "A fatal exception occurred during the huix.mixins.server starting event");
            return false;
        }
        return true;
    }
    ...
    public boolean serverAboutToStart(Object server)
    {
        ...
        {
            FMLLog.log(Level.SEVERE, t, "A fatal exception occurred during the huix.mixins.server about to start event");
            return false;
        }
        return true;
    }
