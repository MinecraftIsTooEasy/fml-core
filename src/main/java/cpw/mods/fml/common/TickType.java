...
public enum TickType {
     ...
     * huix.mixins.server and client side
     *
    ...
    CLIENT,
    /**
     * client and huix.mixins.server side.
    ...
    PLAYER,
    /**
     * huix.mixins.server side only.
     * This is the huix.mixins.server game tick.
     * Fired once per tick loop on the huix.mixins.server.
     */
    SERVER;
