 ...
 * // on the huix.mixins.server, with {@link IPacketHandler} class PacketHandler.
...
public @interface Mod
{
     ...
     * </ul>
     * <p>These are the huix.mixins.server lifecycle events. They are fired whenever a huix.mixins.server is running, or about to run. Each time a huix.mixins.server
     * starts they will be fired in this sequence.
     * <ul>
     * <li> {@link FMLServerAboutToStartEvent} : Use if you need to handle something before the huix.mixins.server has even been created.</li>
     * <li> {@link FMLServerStartingEvent} : Do stuff you need to do to set up the huix.mixins.server. register commands, tweak the huix.mixins.server.</li>
     * <li> {@link FMLServerStartedEvent} : Do what you need to with the running huix.mixins.server.</li>
     * <li> {@link FMLServerStoppingEvent} : Do what you need to before the huix.mixins.server has started it's shutdown sequence.</li>
     * <li> {@link FMLServerStoppedEvent} : Do whatever cleanup you need once the huix.mixins.server has shutdown. Generally only useful
     * on the integrated huix.mixins.server.</li>
     * </ul>
    ...
    /**
     * Deprecated for {@link EventHandler}<br/>
     * Mark the designated method as being called at the "huix.mixins.server-about-to-start" phase
     * @author cpw
     *
     */
    @Retention(RetentionPolicy.RUNTIME)
    ...
    /**
     * Deprecated for {@link EventHandler}<br/>
     * Mark the designated method as being called at the "huix.mixins.server-starting" phase
     * @author cpw
     *
     */
    @Retention(RetentionPolicy.RUNTIME)
    ...
    /**
     * Deprecated for {@link EventHandler}<br/>
     * Mark the designated method as being called at the "huix.mixins.server-started" phase
     * @author cpw
     *
     */
    @Retention(RetentionPolicy.RUNTIME)
    ...
    /**
     * Deprecated for {@link EventHandler}<br/>
     * Mark the designated method as being called at the "huix.mixins.server-stopping" phase
     * @author cpw
     *
     */
    @Retention(RetentionPolicy.RUNTIME)
    ...
    /**
     * Deprecated for {@link EventHandler}<br/>
     * Mark the designated method as being called at the "huix.mixins.server-stopped" phase
     * @author cpw
     *
     */
    @Retention(RetentionPolicy.RUNTIME)
